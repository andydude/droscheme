...
//	return _openZKinputZKbytevector(ToBinary(input))
//}
//
//func OpenTIPort(input string) Any {
//	return _openZKinputZKstring(ToString(input))
//}
...
func (o *CharPort) ReadByte() (c byte, err error) {
	...
	return 0, errors.New("u8-read expected binary-port")
}
