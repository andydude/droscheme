...
func (ls *Pair) Ref(ka Any) Any {
	k := ToFixnum(ka)
	for cur := Any(ls); _pairZS(cur); k, cur = k-1, _cdr(cur) {
		if (k == 0) {
			return _car(cur)
		}
	}
...
func _list(rest ...Any) Any {
	return _vectorZKZRlist(Vector{rest})
}
...
func _circularZKlistZS(x Any) Any {
	return func() Any {
		var _lp func(x, lag Any) Any
		_lp = func(x, lag Any) Any {
			return (_pairZS(x) && func(x Any) Any {
				return (_pairZS(x) && func(x, lag Any) Any {
					return (_eqZS(x, lag) || _lp(x, lag).(bool))
				}(_cdr(x), _cdr(lag)).(bool))
			}(_cdr(x)).(bool))
		}
		return _lp(x, x)
	}()
...
func _dottedZKlistZS(x Any) Any {
	return func() Any {
		var _lp func(x, lag Any) Any
		_lp = func(x, lag Any) Any {
			return func() Any {
...
func _listZS(ls Any) bool {
	return DlistZS(list1(ls)).(bool)
}
...
func _nullZKlistZS(ls Any) bool {
	if _pairZS(ls) {
		return false
	}
	if _nullZS(ls) {
	...
	_error("null-list?: argument out of domain")
	return false
}
func _nullZS(o Any) bool {
	_, ok := o.(*Null)
	return ok
}
func _pairZS(o Any) bool {
	_, ok := o.(*Pair)
	return ok
}
...
func _reverseZA(ls Any) Any {
	return func() Any {
		var _loop func(ls, ans Any) Any
		_loop = func(ls, ans Any) Any {
			return func() Any {
				if _nullZKlistZS(ls) {
					return ans
				}
				return func(tail Any) Any {
					_setZKcdrZA(ls, ans)
					return _loop(tail, ls)
				}(_cdr(ls))
			}()
		}
		return _loop(ls, _null())
	}()
}
func _span() Any {
	return _void()
